      ...
      <div className="max-w-md w-full space-y-8 bg-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-700">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            ...
            className="w-full bg-slate-700 hover:bg-slate-600 py-3 rounded-lg font-bold transition-colors"
          >
            Регистрация
          </button>
        </div>
        ...
        <div className="pt-6 border-t border-slate-700">
          <p className="text-xs text-center text-slate-500 mb-2">Быстрый вход (Dev)</p>
          <div className="flex justify-center space-x-2">
            <button onClick={() => loginAs('admin')} className="px-3 py-1 bg-slate-700 text-xs rounded hover:bg-slate-600">Admin</button>
            <button onClick={() => loginAs('user1')} className="px-3 py-1 bg-slate-700 text-xs rounded hover:bg-slate-600">User1</button>
            <button onClick={() => loginAs('user2')} className="px-3 py-1 bg-slate-700 text-xs rounded hover:bg-slate-600">User2</button>
          </div>
        </div>
      </div>
    </div>
