...
export default function HomePage() {
    ...
    // Mock data for demo
    const [balance, setBalance] = useState({ green: 240, red: 50 });
        ...
        <div className="min-h-screen bg-slate-900 text-white p-4 space-y-6 pt-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    {user?.photo_url ? (
                        <img src={user.photo_url} className="w-12 h-12 rounded-full border-2 border-blue-500" />
                    ) : (
                    ...
                    <div>
                        <h1 className="font-bold text-lg leading-tight">{user?.first_name || 'Гость'}</h1>
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-4 rounded-2xl border border-slate-700 shadow-xl relative overflow-hidden">
                    ...
                    <h2 className="text-2xl font-black text-red-400 mt-1">${balance.red}</h2>
                </div>
                <div className="bg-gradient-to-br from-blue-900/50 to-slate-900 p-4 rounded-2xl border border-blue-800/50 shadow-xl relative overflow-hidden">
                    ...
                    <h2 className="text-2xl font-black text-green-400 mt-1">${balance.green}</h2>
                </div>
            </div>
