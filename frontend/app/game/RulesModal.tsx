                ...
                return (
                    <div className="space-y-6 text-slate-300 leading-relaxed">
                        ...
                        <section>
                            ...
                            <p className="mb-2">
                                <strong className="text-white">Как выйти:</strong> Чтобы выйти на Скоростную дорожку, ваш Пассивный Доход должен превышать Расходы в 2 раза (+ погашен кредит).
                                После выполнения условия появится кнопка выхода.
                            </p>
                            <p className="mb-2">
