...
import { MagicLoginController } from './auth/magic-login.controller';

app.use('/api/auth/magic-login', MagicLoginController);
    ...
    try {
        ...
        try {
            if (isGameServiceOnly) {
                ...
                console.log(`🤖 Running in Monolith Mode (Bot Polling Disabled). PID: ${process.pid}`);
