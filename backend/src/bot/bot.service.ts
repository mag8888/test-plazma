    ...
    initHandlers() {
        ...
        this.bot.on('callback_query', async (query) => {
            ...
            if (data === 'about_avatar_20') {
                const text = `📊 **Пример распределения средств (вход 20$)**\n\n` +
                    `🔹 **Уровень 0 — Входной**\n` +
                    ` • Вход: 20\n` +
                    ...
                    `⸻\n\n` +
                    `🔹 **Уровень 4 — Финальный**\n` +
                    ` • Вход: 240 (сбор 3х участников 4го уровня)\n` +
            ...
            if (data === 'about_avatar_100') {
                // Logic scaled by 5 (20 -> 100)
                const text = `📊 **Пример распределения средств (вход 100$)**\n\n` +
                    `🔹 **Уровень 0 — Входной**\n` +
                    ` • Вход: 100\n` +
                    ` • Каждый приглашает 3 человек по 100\n` +
                    ` • Распределение:\n` +
                    ` • 50 × 3 = 150 → бонус пригласителю\n` +
                    ` • 150 → переход\n\n` +
                    `➡️ **Итог:** Уровень закрыт, переход на уровень 1\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 1>2**\n` +
                    ` • Вход: 150\n` +
                    ` • 3 × 150 = 450\n` +
            ...
            if (data === 'about_avatar_1000') {
                // Logic scaled by 50 (20 -> 1000)
                const text = `📊 **Пример распределения средств (вход 1000$)**\n\n` +
                    `🔹 **Уровень 0 — Входной**\n` +
                    ` • Вход: 1000\n` +
                    ` • Каждый приглашает 3 человек по 1000\n` +
                    ` • Распределение:\n` +
                    ` • 500 × 3 = 1500 → бонус пригласителю\n` +
                    ` • 1500 → переход\n\n` +
                    `➡️ **Итог:** Уровень закрыт, переход на уровень 1\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 1>2**\n` +
