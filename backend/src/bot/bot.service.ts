...
export class BotService {
    ...
    initHandlers() {
        ...
        this.bot.on('callback_query', async (query) => {
            ...
            if (data === 'about_invite') {
                const text = `🔴 **Зачем приглашать друзей и накапливать красный бонус?**\n\n` +
                    `Игра «Монео» — это не просто про деньги.\n` +
                    `Это про среду, связи и стратегию роста.\n` +
                    `Каждый приглашённый вами друг — это +10$ на красный баланс.\n` +
                    `Красный баланс — это ваш игровой капитал, который открывает доступ к более высоким уровням игры.\n\n` +
                    `🎯 **Что даёт красный баланс?**\n` +
                    `🔹 Участие в турнирах\n` +
                    `🔹 Переход на следующие этапы\n` +
                    `🔹 Доступ к призовым фондам\n` +
                    `🔹 Возможность играть без постоянных личных вложений\n\n` +
                    `Красный баланс — это энергия вашей сети.\n` +
                    `Чем она сильнее, тем дальше вы проходите в игре.\n\n` +
                    `🟢 **Как зарабатываются реальные деньги?**\n` +
                    `В турнирах разыгрывается зелёный баланс — это реальные деньги, которые можно выводить на кошелёк.\n\n` +
                    `**Формат турниров:**\n` +
                    `Вход в турнир — 20$\n` +
                    `Переход на второй этап турнира — 100$\n` +
                    `Призовой фонд постоянно будет наполняться и уже в марте мы планируем игру с призовым фондом 15 000$\n\n` +
                    `Победители получают зелёный баланс который можно вывести на кошелек`;

                await this.bot?.sendMessage(chatId, text, { parse_mode: 'Markdown' });
            }

            if (data === 'about_avatar_20') {
                const text = `🔹 **Аватар 20$**\n\n` +
                    `📊 **Пример распределения средств**\n\n` +
                    `При закрытии матрицы игрок получает **480$** на зеленый баланс\n\n` +
                    `Пригласитель того кто закрыл матрицу получает **10$+30$+60$=100$**\n` +
                    `+ подписка на месяц\n` +
                    `+ 20$ красный бонус - на игры и турниры\n` +
                    `+ комиссия за вывод 50%`;

                await this.bot?.sendMessage(chatId, text, {
                    parse_mode: 'Markdown',
                    reply_markup: {
                        inline_keyboard: [[{ text: 'Подробнее 📊', callback_data: 'about_avatar_20_more' }]]
                    }
                });
            }

            if (data === 'about_avatar_20_more') {
                const text = `🔹 **Уровень 0 — Входной**\n` +
                    ` • Вход: 20\n` +
                    ` • Каждый приглашает 3 человек по 20\n` +
                    ` • Распределение:\n` +
                    ` • 10 × 3 = 30 → бонус пригласителю (сразу попадает на баланс)\n` +
                    ` • 30 → на переход на следующий уровень\n` +
                    `➡️ Итог: Уровень закрыт, участник переходит на уровень 1\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 1>2**\n` +
                    ` • Вход: 30\n` +
                    ` • 3 × 30 = 90\n` +
                    ` • Распределение:\n` +
                    ` • 30 → бонус (пригласителю)\n` +
                    ` • 60 → переход\n\n` +
                    `➡️ Переход на уровень 2\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 2>3**\n` +
                    ` • Вход: 60\n` +
                    ` • 3 × 60 = 180\n` +
                    ...
                    ` • 120 → бонус\n` +
                    ` • 240 → переход\n\n` +
                    `➡️ Переход на финальный уровень\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 4 — Финальный**\n` +
                    ` • Вход 4ур: 240 (сбор 3х участников 4го уровня)\n` +
                    ` • 480 → вывод участнику на зеленый бонус\n\n` +
                    `➡️ Цикл завершён. Аватар перестал работать.\n\n` +
                    `⸻\n\n` +
                    `🟢 **Логика системы (коротко)**\n` +
                    ` • Деньги не зависят от глубины сети\n` +
                    ` • Всё строится на личных 3 приглашениях (либо за счет перелива для тех кто забуксовал)\n` +
                    ` • Система легко масштабируется`;

                await this.bot?.sendMessage(chatId, text, { parse_mode: 'Markdown' });
            }

            if (data === 'about_avatar_100') {
                const text = `🔹 **Аватар 100$**\n\n` +
                    `📊 **Пример распределения средств**\n\n` +
                    `При закрытии матрицы игрок получает **2 400$** на зеленый баланс\n\n` +
                    `Пригласитель того кто закрыл матрицу получает **50$+150$+300$=500$**\n` +
                    `+ подписка Мастер на год - можно проводить игры\n` +
                    `+ 150$ красный бонус - на игры и турниры\n` +
                    `+ комиссия за вывод 40%`;

                await this.bot?.sendMessage(chatId, text, {
                    parse_mode: 'Markdown',
                    reply_markup: {
                        inline_keyboard: [[{ text: 'Подробнее 📊', callback_data: 'about_avatar_100_more' }]]
                    }
                });
            }

            if (data === 'about_avatar_100_more') {
                const text = `🔹 **Уровень 0 — Входной**\n` +
                    ` • Вход: 100\n` +
                    ` • Каждый приглашает 3 человек по 100\n` +
                    ` • Распределение:\n` +
                    ` • 50 × 3 = 150 → бонус пригласителю (сразу попадает на баланс)\n` +
                    ` • 150 → на переход на следующий уровень\n` +
                    `➡️ Итог: Уровень закрыт, участник переходит на уровень 1\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 1>2**\n` +
                    ` • Вход: 150\n` +
                    ...
                    `⸻\n\n` +
                    `🔹 **Уровень 4 — Финальный**\n` +
                    ` • Вход 4ур: 1200 (сбор 3х участников 4го уровня)\n` +
                    ` • 2400 → вывод участнику на зеленый бонус\n\n` +
                    `➡️ Цикл завершён. Аватар перестал работать.\n\n` +
                    `⸻\n\n` +
                    `🟢 **Логика системы (коротко)**\n` +
                    ` • Деньги не зависят от глубины сети\n` +
            ...
            if (data === 'about_avatar_1000') {
                const text = `🔹 **Аватар 1000$**\n\n` +
                    `📊 **Пример распределения средств**\n\n` +
                    `При закрытии матрицы игрок получает **24 000$** на зеленый баланс\n\n` +
                    `Пригласитель того кто закрыл матрицу получает **500$+1500$+3000$=5000$**\n\n` +
                    `+ подписка Мастер на год - можно проводить игры\n` +
                    `+ 2000$ красный бонус - на игры и турниры\n` +
                    `+ комиссия за вывод 20%`;

                await this.bot?.sendMessage(chatId, text, {
                    parse_mode: 'Markdown',
                    reply_markup: {
                        inline_keyboard: [[{ text: 'Подробнее 📊', callback_data: 'about_avatar_1000_more' }]]
                    }
                });
            }

            if (data === 'about_avatar_1000_more') {
                const text = `🔹 **Уровень 0 — Входной**\n` +
                    ` • Вход: 1000\n` +
                    ` • Каждый приглашает 3 человек по 1000\n` +
                    ` • Распределение:\n` +
                    ` • 500 × 3 = 1500 → бонус пригласителю (сразу попадает на баланс)\n` +
                    ` • 1500 → на переход на следующий уровень\n` +
                    `➡️ Итог: Уровень закрыт, участник переходит на уровень 1\n\n` +
                    `⸻\n\n` +
                    `🔹 **Уровень 1>2**\n` +
                    ` • Вход: 1500\n` +
                    ...
                    `⸻\n\n` +
                    `🔹 **Уровень 4 — Финальный**\n` +
                    ` • Вход 4ур: 12000 (сбор 3х участников 4го уровня)\n` +
                    ` • 24000 → вывод участнику на зеленый бонус\n\n` +
                    `➡️ Цикл завершён. Аватар перестал работать.\n\n` +
                    `⸻\n\n` +
                    `🟢 **Логика системы (коротко)**\n` +
                    ` • Деньги не зависят от глубины сети\n` +
            ...
            // Community Handlers
            if (data === 'community_moneo') {
                const text = `🎮 **Официальная группа игры MONEO**\n\nПрисоединяйтесь к нашему официальному каналу, чтобы быть в курсе всех новостей и обновлений!`;

                await this.bot?.sendMessage(chatId, text, {
                    parse_mode: 'Markdown',
                    reply_markup: {
                        inline_keyboard: [[{ text: 'Перейти ↗️', url: 'https://t.me/moneo_cash' }]]
                    }
                });
            }

            if (data === 'community_channel') {
                const text = `📢 **Официальный канал MONEO**\n\nНовости, анонсы и важные обновления.`;

                await this.bot?.sendMessage(chatId, text, {
                    parse_mode: 'Markdown',
                    reply_markup: {
                        inline_keyboard: [[{ text: 'Перейти ↗️', url: 'https://t.me/moneo_official' }]]
                    }
                });
            }

            if (data === 'community_nomads') {
                const text = `🌍 **Цифровые кочевники**\n\n` +
                    `Создал чат для русскоязычных цифровых кочевников, которые живут или собираются жить за границей.\n\n` +
                    `**Здесь можно:**\n` +
                    `— задать вопрос и получить нормальный ответ\n` +
                    `— обсудить визы, жильё, банки и работу\n` +
                    `— поделиться опытом и контактами\n` +
                    `— избежать скама и спама\n` +
                    `— организовать встречу с нужными людьми\n` +
                    `— получить помощь в привлечении инвестиций`;

                await this.bot?.sendMessage(chatId, text, {
                    parse_mode: 'Markdown',
                    reply_markup: {
                        inline_keyboard: [[{ text: 'Перейти ↗️', url: 'https://t.me/+fLfUCWaXENJjNmIy' }]]
                    }
                });
            }
        ...
        this.bot.onText(/\/game/, async (msg) => {
            ...
            try {
                ...
                const baseUrl = process.env.PUBLIC_BASE_URL || 'https://moneo-live.up.railway.app';
                ...
                if (masterState.state === 'WAITING_DATE') {
                    ...
                    if (match) {
                        ...
                        if (h >= 0 && h < 24 && m >= 0 && m < 60) {
                            // Normalize to HH:mm
                            const normalized = `${String(h).padStart(2, '0')}:${String(match[2])}`;
                            this.handleTimeSelection(chatId, normalized);
                        } else {
                            this.bot?.sendMessage(chatId, "❌ Некорректное время. (00:00 - 23:59)");
                        }
                    } else {
                        this.bot?.sendMessage(chatId, "❌ Формат: ЧЧ:ММ (или через точку/запятую/пробел). Пример: 18:00");
                    }
                    return;
    ...
    async handleEarn(chatId: number, telegramId?: number) {
        ...
        try {
            ...
            const botName = (process.env.BOT_USERNAME || 'MONEO_game_bot').replace('@', '');
    ...
    handleCommunity(chatId: number) {
        this.bot?.sendMessage(chatId, `🌐 **Сообщество MONEO**\n\nВыберите интересующую вас группу:`, {
            parse_mode: 'Markdown',
            reply_markup: {
                inline_keyboard: [
                    [{ text: 'Канал MONEO', callback_data: 'community_channel' }],
                    [{ text: 'Группа игры MONEO', callback_data: 'community_moneo' }]
                ]
            }
        });
    }
    ...
    handleAbout(chatId: number) {
        const text = `«Moneo» — это новая образовательная игра, созданная на основе принципов CashFlow.\n` +
            `Она помогает менять мышление, прокачивать навыки и открывать новые финансовые возможности.`;

        this.bot?.sendMessage(chatId, text, {
            reply_markup: {
                inline_keyboard: [
                    [{ text: '🔴 Зачем приглашать друзей?', callback_data: 'about_invite' }],
                    [{ text: 'Аватар за 20$', callback_data: 'about_avatar_20' }],
                    [{ text: 'Аватар за 100$', callback_data: 'about_avatar_100' }],
                    [{ text: 'Аватар за 1000$', callback_data: 'about_avatar_1000' }]
                ]
            }
        });
    }
